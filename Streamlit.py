...
#features=['age','traveltime','freetime','health','studytime','activities','internet','absences','G1','G2','failures']
...
#features=['age','traveltime','freetime','health','studytime','activities','internet','absences','G1','G2','failures']
data=joblib.load("Random_forest.pkl")
model=data["model"]
encoder=data["encoder"]

new_info=[age,traveltime,freetime,health,studytime,activities,internet,absences,g1,g2,failures]
